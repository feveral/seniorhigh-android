...
public class Config {
    ...
    public static final String DESIGNATED_FIRST_YEAR = "109";
    public static final String DESIGNATED_SECOND_YEAR = "108";

    public static final String BASIC_FIRST_YEAR = "109";
    public static final String BASIC_SECOND_YEAR = "108";

    public static final String UNIFY_FIRST_YEAR = "109";
    public static final String UNIFY_SECOND_YEAR = "108";
    ...
    public static final int BASIC_EXAMINE_DAY = 22;
    ...
    private static final String dataBaseFileName = "grade_2020_0925.db";
    private static final int databaseResourceId = R.raw.grade_2020_0925;
