...
public class DesignatedSecondAdapter extends RecyclerView.Adapter<DesignatedSecondAdapter.ViewHolder>{
    ...
    public DesignatedSecondAdapter(DesignatedFragment fragment){
        this.fragment = fragment;
        search = new SearchDesignatedGrade();
        gradeList = search.getSecondGroupList(firstYear);
        DesignatedGrade.sortHighToLow(gradeList);
    }

    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{

        private DesignatedSecondAdapter.ViewHolder.ViewHolderClick listener;
        ...
        public void setOnClickListener(DesignatedSecondAdapter.ViewHolder.ViewHolderClick listener){
    ...
    @Override
    public DesignatedSecondAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        View view = LayoutInflater.from(context).inflate(R.layout.item_group,parent,false);
        return new DesignatedSecondAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DesignatedSecondAdapter.ViewHolder holder, int position) {
