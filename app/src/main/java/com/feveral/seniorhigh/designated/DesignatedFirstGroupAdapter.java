...
/**
 * Created by feveral on 2017/8/6.
 */

public class DesignatedFirstGroupAdapter extends RecyclerView.Adapter<DesignatedFirstGroupAdapter.ViewHolder> {
    ...
    public DesignatedFirstGroupAdapter(DesignatedFragment fragment){
        this.fragment = fragment;
        search = new SearchDesignatedGrade();
        gradeList = search.getFirstGroupList(firstYear);
    ...
    @Override
    public DesignatedFirstGroupAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(DesignatedFirstGroupAdapter.ViewHolder holder, int position) {
